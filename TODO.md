...
- [x] Phase 4: Scripted provider — bwrap-sandboxed Python subprocess, stdin/stdout JSON lines protocol, long-lived process across turns; design in docs/design/providers/scripted.md
